	...
	var Form = React.createClass({
		...
		render: function render() {
			...
			var listone = list.map(function (data) {
				...
				return React.createElement('li', null, React.createElement('span', null, id), React.createElement('span', null, name), React.createElement('span', null, age), React.createElement('span', null, time));
			});

			return React.createElement('div', null, React.createElement('ul', { 'class': 'jk-from' }, listone));
		}
	});
	module.exports = Form;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({
		...
		render: function render() {
			return React.createElement("header", { className: "jk-header" }, React.createElement("h1", null, "极客学院"));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = __webpack_require__(34); //头部
	var From = __webpack_require__(1); //头部
	var Jkindex = React.createClass({
		displayName: 'Jkindex',

		render: function render() {
			return React.createElement('div', null, React.createElement(Header, null), React.createElement(From, { source: '/all' }));
		}
	});
	ReactDOM.render(React.createElement(Jkindex, null), document.getElementById('meeting'));
